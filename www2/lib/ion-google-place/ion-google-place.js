                    ...
                    var POPUP_TPL = [
                        '<div class="ion-google-place-container">',
                            ...
                            '<ion-content class="has-header has-header">',
                                '<ion-list>',
                                    '<ion-item ng-repeat="location in locations" type="item-text-wrap" ng-click="selectLocation(location)" style="color:#000; white-space: normal; line-height: 1.5">',
                    ...
                    popupPromise.then(function(el){
                        ...
                        scope.$watch('searchQuery', function(query){
                            ...
                            searchEventTimeout = $timeout(function() {
                                if(!query) { scope.locations = ""; return; }
                                //if(query.length < 3) { scope.locations = ""; return; }
                                var data = {
                                  bounds: {
                                    west: 101.380166,
                                    east: 102.08329,
