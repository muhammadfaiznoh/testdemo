(function () {
    ...
    _module.controller('LightHouseCtrl', function ($rootScope, $scope, ControllerBase, u, App, apiCamera, $ionicNavBarDelegate, $http, $ionicFilterBar, $ionicLoading, $ionicModal, $ionicScrollDelegate) {
