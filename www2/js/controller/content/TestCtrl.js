    (function () {
        ...
        _module.controller('TestCtrl', function ($scope, ControllerBase, $cordovaDevice, $cordovaFile, $ionicPlatform, $cordovaEmailComposer, $ionicActionSheet, ImageService, FileService) {
            ControllerBase($scope, 'test');
