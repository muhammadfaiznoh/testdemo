(function () {
    ...
    _module.factory('u', function(
        ...
        _self.$ionicHistory = $ionicHistory;
        ...
        _self.closeLoading = function() {
            loading.close();
        }
        
        _self.showAlert = function(o) {
            return popup.error(o);
        }
        
        _self.triggerPullToRefreshAnimation = function(delegate){
            pullToRefresh.triggerPtr(delegate)
        }
